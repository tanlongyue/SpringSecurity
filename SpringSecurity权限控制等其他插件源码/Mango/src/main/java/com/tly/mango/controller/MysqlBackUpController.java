...
import com.tly.mango.database.BackupDataSourceProperties;
...
import com.tly.mango.util.backup.BackupConstants;
...
public class MysqlBackUpController {
    ...
    private HttpResult backup(String backupFodlerName) {
        ...
        try {
            ...
            if(!success) {
                HttpResult.buildError("数据备份失败");
            }
        } catch (Exception e) {
            return HttpResult.buildError( e.getMessage(),500);
        }
